  ...
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Get.to(ProposalPage(id: widget.id.toString(),leadid:widget.id.toString()));
          },
        ),
        body: Obx(() {
            ...
            return Padding(
              ...
              child: RefreshIndicator(
                ...
                child: ListView.builder(
                    itemCount:
                        proposalGetController.getproposallist[0].data.length,
                    itemBuilder: (context, index) {
                      var item =
                          proposalGetController.getproposallist[0].data[index];
                        ...
                        child: Column(
                          children: [
                            Container(
                                ...
                                child: Card(
                                  color: proposalindex == index
                                      ? Color.fromARGB(255, 50, 53, 69)
                                      : screenbackground,
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            item.edit == '1'
                                                ? InkWell(
                                                    onTap: () {
                                                     // log(item.proposalid.toString());
                                                     Get.to(ProposalEditPage(proposalid:item.proposalid.toString(),leadid:item.leadid.toString()),);
                                                    },
                                                    child: Container(
                                                        height: 4.0.hp,
                                                        width: 15.0.wp,
